...
def load():
    ...
    actor_df = pd.read_csv("/Users/shubhamgondane/Desktop/MWDB/Project/Phase2_data/imdb-actor-info.csv")
    actor_list = list(set(actor_df['id']))

    movies_df = pd.read_csv("/Users/shubhamgondane/Desktop/MWDB/Project/Phase2_data/movie-actor.csv")

    movie_list = list(set(movies_df['movieid']))
    year_df = pd.read_csv("/Users/shubhamgondane/Desktop/MWDB/Project/Phase2_data/mlmovies.csv")
